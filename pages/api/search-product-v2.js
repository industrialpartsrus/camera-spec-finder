...
const PRODUCT_TYPE_TO_EBAY_CATEGORY = {
  ...
  // ==================== BEARINGS ====================
  // 181750 = Ball & Roller Bearings (generic: ball, roller, needle)
  // 181752 = Cam Followers (specific subcategory — more item specifics!)
  // 181753 = Mounted Bearings & Housings (pillow blocks, flange bearings)
  // 181754 = Thrust Bearings (specific subcategory)
  ...
  'Thrust Bearing': { ebayCategoryId: '181754', ebayCategoryName: 'Thrust Bearings' },
  'Pillow Block': { ebayCategoryId: '181753', ebayCategoryName: 'Mounted Bearings & Housings' },
  'Pillow Block Bearing': { ebayCategoryId: '181753', ebayCategoryName: 'Mounted Bearings & Housings' },
  'Flange Bearing': { ebayCategoryId: '181753', ebayCategoryName: 'Mounted Bearings & Housings' },
  'Cam Follower': { ebayCategoryId: '181752', ebayCategoryName: 'Cam Followers' },
...
**MOTORS:** ratedloadhp, baserpm, voltage, fullloadamps, phase, enclosuretype, mountingtype, framesize, shaftdiameter, currenttype, servicefactor, insulationclass
**VFDs/DRIVES:** inputvoltage, outputvoltage, ratedcurrent, ratedpower, phase, communicationstandard, enclosuretype
...
Return ONLY valid JSON (no markdown, no code blocks):
{
  ...
  "title": "Professional eBay title, max 80 characters, include brand, model, key specs, product type",
...
6. TITLE RULES:
   ...
   - Max 80 characters
   - Example: "McGill CFH 2 3/4 S Cam Follower Heavy Stud Screwdriver Slot CAMROL"

DESCRIPTION FORMAT (must be valid HTML):
<p>[2-3 sentence professional introduction explaining what this product is, its purpose, and key features. NO promotional language. NO condition references.]</p>
...
- Title must NEVER contain condition words (New, Used, Refurbished, etc.)
...
- Include as many technical specs as you can find -- aim for 8+ specifications minimum`;
}
