...
// Drop this into your existing Firebase project
// ============================================================
...
// ------------------------------------------------------------
// CONFIGURATION - Update with your Firebase project values
// ------------------------------------------------------------
const VAPID_KEY = 'YOUR_VAPID_KEY_HERE'; // Generate in Firebase Console → Project Settings → Cloud Messaging → Web Push certificates
