...
// =============================================================================
// AI_FIELD_OVERRIDES: Maps common AI-generated field names to canonical SureDone fields.
// Checked FIRST in resolveSpecFieldName() before Set/alias/substring matching.
// All targets verified to exist in SUREDONE_FIELD_NAMES or SUREDONE_EBAY_ONLY_FIELDS.
// =============================================================================
const AI_FIELD_OVERRIDES = {
  // Communication variants → communicationstandard
  'communicationprotocol': 'communicationstandard',
  'communicationprotocols': 'communicationstandard',
  'communicationinterface': 'communicationstandard',
  'protocolsupport': 'communicationstandard',
  'networkprotocol': 'communicationstandard',

  // Mounting variants → mountingtype
  'mountingmethod': 'mountingtype',
  'mounttype': 'mountingtype',
  'mountmethod': 'mountingtype',
  'mountstyle': 'mountingtype',

  // Current/amperage variants
  'ratedinputcurrent': 'inputamperage',
  'inputcurrent': 'inputamperage',
  'outputcurrent': 'outputamperage',
  'ratedoutputcurrent': 'outputamperage',
  'ratedcurrent': 'currentrating',
  'maxcurrent': 'maximumamperage',
  'maximumcurrent': 'maximumamperage',

  // Voltage variants
  'powersupplyvoltage': 'supplyvoltage',
  'supplyvoltagerange': 'supplyvoltage',
  'operatingvoltage': 'voltage',
  'ratedvoltage': 'voltage',
  'maxvoltage': 'maximumoperatingvoltage',
  'maximumvoltage': 'maximumoperatingvoltage',

  // Response/timing → responsetime
  'switchingtime': 'responsetime',
  'reactiontime': 'responsetime',

  // Display → displayresolution (SUREDONE_EBAY_ONLY_FIELDS)
  'screenresolution': 'displayresolution',
  'resolution': 'displayresolution',

  // Weight → emptyweight
  'weight': 'emptyweight',
  'netweight': 'emptyweight',
  'unitweight': 'emptyweight',

  // Enclosure variants → enclosuretype
  'enclosurerating': 'enclosuretype',
  'nemarating': 'enclosuretype',
  'nemaenclosure': 'enclosuretype',

  // Temperature variants
  'operatingtemperaturerange': 'temperaturerange',
  'ambienttemperature': 'operatingtemperature',
  'ambienttemperaturerange': 'operatingtemperature',

  // Memory → memorysize (SUREDONE_EBAY_ONLY_FIELDS)
  'memory': 'memorysize',
  'programmemory': 'memorysize',
  'usermemory': 'memorysize',

  // Protection/IP rating
  'ipprotection': 'iprating',
  'ingressprotection': 'iprating',
  'ingress': 'iprating',
  'protectionclass': 'protectionproperties',
  'protectionrating': 'protectionproperties',

  // Housing → housingmaterial (SUREDONE_EBAY_ONLY_FIELDS)
  'housing': 'housingmaterial',
  'casingmaterial': 'housingmaterial',
  'enclosurematerial': 'housingmaterial',

  // Power → powerrating
  'powerdissipation': 'powerrating',
...
export function resolveSpecFieldName(aiSpecKey) {
  ...
  // Tier 0: AI field override (catches known AI naming patterns before any other check)
  if (AI_FIELD_OVERRIDES[shortName]) {
    return AI_FIELD_OVERRIDES[shortName];
  }
